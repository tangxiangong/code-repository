...
kappa = 1;
alpha = 0.7;
[~, u1] = fem(alpha, T, a, b, tau, h, f, g, mu, kappa);
[~, u2] = fem(alpha, T, a, b, tau, h/2, f, g, mu, kappa);
[~, u3] = fem(alpha, T, a, b, tau, h/4, f, g, mu, kappa);
% [~, u4] = fem(alpha, T, a, b, tau/8, h, f, g, mu, kappa);
% [~, u5] = fem(alpha, T, a, b, tau/16, h, f, g, mu, kappa);
% [~, u6] = fem(alpha, T, a, b, tau/32, h, f, g, mu, kappa);
